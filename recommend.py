...
def group_by_centroid(restaurants, centroids):
    ...
    """
    # BEGIN Question 4
    cluster_pairs = [[find_closest(restaurant_location(restaurant), centroids), restaurant] for restaurant in restaurants]
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    best_feature = max(feature_fns, key = lambda feature_fn: find_predictor(user, reviewed, feature_fn)[1])
